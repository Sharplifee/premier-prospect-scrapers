#!/usr/bin/env python3
"""Premier Prospect™ — MLS Expired Listings | Score 95 | signal_type: expired_listing"""
...
def _ure_headers(cookie, referer=''):
    return {
        ...
        'Referer': referer or _URE_BASE + '/', 'cache-control': 'no-cache',
    }
    ...
    for page in range(1, 6):
        ...
        for listno in listnos:
            ...
            signals.append({
                ...
                'score': SCORE, 'raw_address': listing['address'],
